...
with tab3:
    st.markdown('<div class="card-container">', unsafe_allow_html=True)
    st.markdown("<h2>📋 Comprehensive Enterprise Database Registry</h2>")
    st.markdown("<p style='color: #64748b; margin-bottom: 1.5rem;'>Interactive relational tabular view containing full available customer transaction properties.</p>", unsafe_allow_html=True)
